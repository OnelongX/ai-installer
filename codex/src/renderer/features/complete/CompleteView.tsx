...
const providerHighlights = [
  '兼容 OpenAI 接口，开箱接入 Codex / Cursor / Cline 等工具链',
  '默认配置已写好 GPT-5.5 (high reasoning)，无需额外调参',
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '920px', margin: '0 auto', display: 'grid', gap: '18px' }}>
        ...
        <h1 style={{ margin: 0 }}>
          {summary.status === 'ready' ? 'Codex 已可使用。' : 'Codex 已完成安装，但包含警告。'}
        </h1>
        <div
          style={{
            borderRadius: '24px',
        ...
        >
          <p style={{ margin: 0 }}>
            版本：<span>{summary.codexVersion}</span>
          </p>
        ...
        >
          ...
          <p style={{ margin: 0, color: '#cbd5e1', lineHeight: 1.6 }}>
            本次安装已将默认模型提供方配置为 LiveToken。它是一个面向 Codex / 开发者工具的
            OpenAI 兼容网关：
          </p>
          <ul
            style={{
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
            ...
            >
              {actionLabel ??
                (desktopApp.installed ? '打开 Codex 桌面版' : '前往安装 Codex 桌面版')}
            </button>
          </div>
        </div>
      </div>
