...
import { ensureConfigToml } from '../main/installer/tasks/write-config.windows'
...
function setupSmokeTest(window: BrowserWindow) {
  ...
  window.webContents.once('did-finish-load', () => {
    void window.webContents
      .executeJavaScript(
        'typeof window.codexInstaller !== "undefined" || typeof window.require === "function"',
        true
      )
