...
![api-key-step](docs/screenshots/api-key.png)
...
? Node.js：未安装 → 自动修复
? Claude Code CLI：未安装 → 自动修复
✓ Claude 配置：将在首次启动时自动生成
```
...
- 装 Claude Code CLI 用 npm，国内网络可能要 1–3 分钟
- 写配置和环境变量是秒级
...
如果显示版本号并能进 Claude Code REPL，就成了。
